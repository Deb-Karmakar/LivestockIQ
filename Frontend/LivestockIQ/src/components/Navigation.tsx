      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {/* 3. Add onClick to navigate to the /login route */}
            <Button variant="ghost" data-testid="button-login" onClick={() => navigate('/login')}>
              Log In
            </Button>
            {/* 4. Add onClick to navigate to the /register route */}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-border">
              ...
              <div className="pt-4 pb-3 border-t border-border">
                <div className="flex flex-col space-y-3">
                  {/* 5. Add onClick for the mobile login button */}
                  <Button
                    variant="ghost"
                  ...
                  {/* 6. Add onClick for the mobile join button */}
                  <Button
                    className="justify-start"
