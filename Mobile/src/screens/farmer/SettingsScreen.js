...
const SettingsScreen = () => {
    ...
    const handleLogout = () => {
        Alert.alert(
            t('logout'),
            t('delete_animal_confirm').replace('delete this animal', 'logout'), // Reusing confirm message structure or creating new one
            [
        ...
        <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
            <View style={[styles.header, { backgroundColor: theme.card, borderBottomColor: theme.border }]}>
                <View style={styles.profileSection}>
                    ...
                    <Text style={[styles.name, { color: theme.text }]}>{user?.farmOwner || 'Farmer'}</Text>
                    <Text style={[styles.email, { color: theme.subtext }]}>{user?.email}</Text>
                    {user?.farmName && <Text style={[styles.farm, { color: theme.primary }]}>{user.farmName}</Text>}
                </View>
            </View>
